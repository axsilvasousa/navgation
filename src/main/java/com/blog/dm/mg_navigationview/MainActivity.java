...
public class MainActivity extends AppCompatActivity {
    ...
    private Fragment fragmentoNovo = new FragmentClass();
    ...
    public void selecteOption(int id) {
        ...
        switch (id) {
            case R.id.action_first_choice: {
                ...
                fragmentManager.beginTransaction().replace(R.id.main_layout, fragmentoNovo, "NOME_FRAGMENTO").addToBackStack("NOME_FRAGMENTO").commit();
                break;
            }
